...
export default function Team() {
    const teamMembers = [
        { name: "Hamdan Raza", role: "Frontend and Backend Developer", imageUrl: hamdanImg, linkedIn: "" },
        { name: "Aryan Khan", role: "Frontend and Backend Developer", imageUrl: aryanImg, linkedIn: "" },
        { name: "Malik Majeed", role: "Frontend and Backend Developer", imageUrl: majeedImg, linkedIn: "" },
        { name: "Muhammad Atif", role: "Frontend Developer", imageUrl: atifImg, linkedIn: "" },
        { name: "Salman Ali", role: "Tester", imageUrl: salmanImg, linkedIn: "" },
        { name: "Laiba Hamid", role: "Web Designer", imageUrl: dummyImg, linkedIn: "" },
        { name: "Emaan Sheeraz", role: "Web Designer", imageUrl: dummyImg, linkedIn: "" },
        { name: "Asad Ullah", role: "Documentations", imageUrl: asadImg, linkedIn: "" },
        { name: "Muhammad Musanif", role: "Documentations", imageUrl: majeedImg, linkedIn: "" },
        { name: "Faisal Hashim", role: "Tester", imageUrl: faisalImg, linkedIn: "" },
    ];
                ...
                {paginatedMembers.map((member, index) => (
                    ...
                    >
                        ...
                        <div className="flex space-x-4">
                            {member.linkedIn && (
                                <Link to={member.linkedIn} className="text-gray-500 hover:text-blue-600">
